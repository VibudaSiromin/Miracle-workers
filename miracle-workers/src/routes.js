...
//test junction
const TestJunction = React.lazy(() =>
  import('./views/testJunction/TestJunction')
);
//test json
...
const loadFormJson = React.lazy(() =>
  import('./components/loadFromJson/loadFromJson')
);
...
const routes = [
  ...
  {
    path: '/dataJunction/dataExcel/:dname',
    name: 'DataExcel',
    element: DataExcel,
  },
  {
    path: '/testJunction/testManual/:tname',
    name: 'TestManual',
    element: TestManual,
  },
